...
> * [About](https://github.com/PycraftDeveloper/Pycraft/tree/installer#about)
> * [Preview Video](https://youtu.be/shAprkrcaiI)
> * [Setup](https://github.com/PycraftDeveloper/Pycraft/tree/installer#setup)
> * * [Installing the project (recommended)](https://github.com/PycraftDeveloper/Pycraft/tree/installer#installing-the-project-recommended)
> * * [Installing the project (manual approach)](https://github.com/PycraftDeveloper/Pycraft/tree/installer#installing-the-project-manual-approach)
> * [Execution](https://github.com/PycraftDeveloper/Pycraft/tree/installer#execution)
> * [Credits](https://github.com/PycraftDeveloper/Pycraft/tree/installer#credits)
> * [Changes](https://github.com/PycraftDeveloper/Pycraft/tree/installer#changes)
> * [Understanding the Release Notes](https://github.com/PycraftDeveloper/Pycraft/tree/installer#understanding-the-release-notes)
> * [Input Mapping](https://github.com/PycraftDeveloper/Pycraft/tree/installer#input-mapping)
> * [Our Update Policy](https://github.com/PycraftDeveloper/Pycraft/tree/installer#our-update-policy)
> * [Version Naming](https://github.com/PycraftDeveloper/Pycraft/tree/installer#version-naming)
> * [Final Notices](https://github.com/PycraftDeveloper/Pycraft/tree/installer#final-notices)

> * [The Planned Storyline](https://github.com/PycraftDeveloper/Pycraft/blob/main/Planned_Storyline.md#the-planned-storyline)
> * [Sound Preview](https://github.com/PycraftDeveloper/Pycraft/blob/installer/main.md#pycrafts-sound-files---preview-1)
